...
const Contact = () => {
  return (
    <section id="contact" className="py-32 bg-axio-navy/50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <a href="mailto:hello@axio.tech" className="flex items-center gap-4 bg-axio-navy/80 border border-white/10 rounded-lg p-6 hover:border-axio-pink/50 transition-all group">
            ...
            <a href="tel:+61470735341" className="flex items-center gap-4 bg-axio-navy/80 border border-white/10 rounded-lg p-6 hover:border-axio-pink/50 transition-all group">
              <div className="w-12 h-12 bg-white/5 rounded-lg flex items-center justify-center group-hover:bg-axio-pink/20 transition-all">
                <Phone size={24} />
              </div>
              <div className="text-left">
